...
import '../../payments/presentation/razorpay_checkout_dialog.dart';
            ...
            itemBuilder: (context, index) {
              ...
              return Material(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    final priceVal = double.tryParse(amount) ?? 1999.0;
                    showDialog(
                      context: context,
                      builder: (ctx) => RazorpayCheckoutDialog(
                        planId: (o['plan_id'] as String?) ?? 'standard_monthly',
                        planName: 'Membership Renewal (${stage.toUpperCase()})',
                        priceInr: priceVal > 0 ? priceVal : 1999.0,
                        durationDays: 30,
                      ),
                    );
                  },
