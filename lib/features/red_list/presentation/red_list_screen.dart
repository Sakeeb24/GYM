                      ...
                      builder: (ctx) => SafeArea(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'RETENTION OUTREACH: ${caseItem.memberName.toUpperCase()}',
                              ...
                              ListTile(
                                ...
                                title: const Text('Call Athlete Direct'),
                                subtitle: const Text('Direct voice check-in and re-engagement'),
                                onTap: () {
                                  Navigator.pop(ctx);
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text('Dialing ${caseItem.memberName}...')),
                                  );
                                },
                              ),
                              ListTile(
                                leading: const Icon(Icons.chat_rounded, color: AppColors.success),
                                title: const Text('Send WhatsApp Check-in'),
                                subtitle: const Text('"Hey! We missed you at the gym this week..."'),
                                onTap: () {
                                  Navigator.pop(ctx);
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text('WhatsApp template launched for ${caseItem.memberName}')),
                                  );
                                },
                              ),
                              ListTile(
                                leading: const Icon(Icons.notes_rounded, color: AppColors.warning),
                                title: const Text('Log Outreach Note'),
                                subtitle: const Text('Record notes for staff follow-up history'),
                                onTap: () {
                                  Navigator.pop(ctx);
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(content: Text('Outreach note recorded.')),
                                  );
                                },
                              ),
                            ],
