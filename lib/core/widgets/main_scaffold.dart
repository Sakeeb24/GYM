...
import '../../features/memberships/presentation/member_membership_screen.dart';
...
class _MainScaffoldState extends ConsumerState<MainScaffold> {
  ...
  Widget build(BuildContext context) {
    // ── Desktop / Web Responsive Layout for Gym Owner ────────────────────────
    final isDesktop = MediaQuery.of(context).size.width >= 900;
    if (widget.role == AppRole.owner && isDesktop) {
