...
class AppBadge extends StatelessWidget {
  ...
  factory AppBadge.status(String status) {
    Color col = AppColors.brand;
    final s = status.toLowerCase();
    if (s == 'active' || s == 'success' || s == 'succeeded') {
      col = AppColors.success;
    } else if (s == 'expired' || s == 'danger' || s == 'overdue' || s == 'failed') {
      col = AppColors.error;
    } else if (s == 'expiring' || s == 'warning' || s == 'pending' || s == 'frozen' || s == 'paused') {
  ...
  factory AppBadge.source(String source) {
    return AppBadge(
